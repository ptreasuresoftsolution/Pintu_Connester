...
public class SessionPref {
    ...
    private final String IS_NOTIFICATION_OFF = "IS_NOTIFICATION_OFF";
    ...
    public void setNotificationOFF(boolean isOff) {
        setBoolean(IS_NOTIFICATION_OFF, isOff);
    }

    public boolean isNotificationOFF() {
        return getBoolean(IS_NOTIFICATION_OFF);
    }
